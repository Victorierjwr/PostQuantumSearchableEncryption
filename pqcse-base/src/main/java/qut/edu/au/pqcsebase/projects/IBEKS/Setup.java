...
import qut.edu.au.pqcsebase.projects.IBEKS.vo.PP;
import qut.edu.au.pqcsebase.tools.BigIntMatrix;
import qut.edu.au.pqcsebase.tools.LatticeHashUtils;

import java.math.BigInteger;
import java.util.List;

import static qut.edu.au.pqcsebase.algorithms.TrapGen.trapGen;
import static qut.edu.au.pqcsebase.projects.IBEKS.Params.*;
import static qut.edu.au.pqcsebase.tools.VectorUtils.innerProduct;
import static qut.edu.au.pqcsebase.tools.VectorUtils.randomVector;
...
public class Setup {
    ...
    public Setup(){
        ...
        this.pp.A = matrices[0]; m = this.pp.A.getColumnDimension();
