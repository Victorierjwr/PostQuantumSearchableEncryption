...
import qut.edu.au.pqcsebaseopt.projects.IBEKS.vo.CT;
...
import static qut.edu.au.pqcsebaseopt.algorithms.ErrorDistribution.generateError;
...
public class Encrypt {
    ...
    public static CT encrypt(Setup setup, String identity, String keyword) {
        ...
        System.out.println("R size: " + R.getRows() + "x" + R.getCols());
        ...
        System.out.println("B_vyA size: " + B_vyA.getRows() + "x" + B_vyA.getCols());
