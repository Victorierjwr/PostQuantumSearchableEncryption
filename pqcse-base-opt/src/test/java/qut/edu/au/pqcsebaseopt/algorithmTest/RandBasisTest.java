...
import static qut.edu.au.pqcsebaseopt.algorithms.RandBasis.randBasis;
import static qut.edu.au.pqcsebaseopt.algorithms.RandBasis.randBasisPre;
import static qut.edu.au.pqcsebaseopt.algorithms.SamplePre.computeGaussParam;
...
public class RandBasisTest {
    ...
    public long testRandBasis() {
        ...
        sigma = computeGaussParam(S) * 1000;
        // ---------------------------------------------------------------------

        System.out.println("Input S dimensions: " + S.getRows() + " x " + S.getCols());
        ...
        System.out.println("Output S_randomized dimensions: " + S_randomized.getRows() + " x " + S_randomized.getCols());
    ...
    private boolean checkZero(BigIntMatrix bigIntMatrix) {
        for (int i = 0; i < bigIntMatrix.getRows(); i++) {
            for (int j = 0; j < bigIntMatrix.getCols(); j++) {
