...
import qut.edu.au.pqcsebaseopt.algorithms.TrapGenFirst;
import qut.edu.au.pqcsebaseopt.tools.BigIntMatrix;

import java.math.BigInteger;

import static qut.edu.au.pqcsebaseopt.algorithms.TrapGen.trapGen;
import static qut.edu.au.pqcsebaseopt.tools.BigIntMatrix.GSN_Length;
...
//        BigIntMatrix A1 = BigIntMatrix.fromArray(demo,qBig);
        ...
        System.out.println("A1 * H: " + A1.multiplyQ(H).isZeroMatrix());
